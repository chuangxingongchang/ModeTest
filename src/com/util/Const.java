...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((wxlogin)|(login)|(logout)|(code)|(app)|(ucan/canInfo)|(FinanceHome)|(index)|(NEWdindScanQRLogin)|(FTPFileController)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)|(mobile)|(uploadFiles)).*";	//不对匹配该值的访问路径拦截（正则）
