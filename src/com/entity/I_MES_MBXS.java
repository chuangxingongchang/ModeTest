...
public class I_MES_MBXS {
    ...
    public void setLinePlan(String linePlan) {
    ...
    public Double getPartWith() {
        return partWith;
    }

    public void setPartWith(Double partWith) {
        this.partWith = partWith;
    }
    ...
    public void setLineUsage(Double lineUsage) {
    ...
    public String getHandleVacancy() {
        return handleVacancy;
    }

    public void setHandleVacancy(String handleVacancy) {
        this.handleVacancy = handleVacancy;
    }
